...
- Name: api/users/updateInfoUser.spec.ts >> Update User Info API >> USER_API_011 - should update email successfully
- Location: tests/api/users/updateInfoUser.spec.ts:163:7
