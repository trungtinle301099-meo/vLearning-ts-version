...
- Name: ui/home/danhMuc.ui.spec.ts >> Home - Danh mục khóa học >> DANH_MUC_UI_001 - should navigate to Backend course category page when clicking Lập trình Backend
- Location: tests/ui/home/danhMuc.ui.spec.ts:6:7
...
Call log:
  - waiting for getByRole('link', { name: 'Lập trình Backend', exact: true })
    - locator resolved to <a href="/danhmuckhoahoc/BackEnd">Lập trình Backend</a>
