...
- Name: ui/home/danhMuc.ui.spec.ts >> Home - Danh mục khóa học >> DANH_MUC_UI_003 - should navigate to Mobile course category page when clicking Lập trình di động
- Location: tests/ui/home/danhMuc.ui.spec.ts:60:9
...
Call log:
  - waiting for getByRole('link', { name: 'Lập trình di động', exact: true })
    - locator resolved to <a href="/danhmuckhoahoc/DiDong">Lập trình di động</a>
