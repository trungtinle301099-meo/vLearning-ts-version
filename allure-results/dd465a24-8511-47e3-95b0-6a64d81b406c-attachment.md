...
- Name: ui/register/register.ui.spec.ts >> Register UI >> REGISTER_UI_002 - should not register with existing username
- Location: tests/ui/register/register.ui.spec.ts:57:7
...
Received string:  "https://demo2.cybersoft.edu.vn/login"
Timeout: 5000ms

Call log:
  - Expect "toHaveURL" with timeout 5000ms
    14 × unexpected value "https://demo2.cybersoft.edu.vn/login"

```

```yaml
- heading "ĐĂNG KÝ" [level=2]
- textbox "Tài khoản": taikmrcki1nb950
- textbox "Họ tên": Auto Test Elinor Lynch
- textbox "Mật khẩu": "@Djsnm6917"
- textbox "Email": taikmrcki1nc075_5720@gmail.com
- textbox "Số điện thoại": "0913246435"
- combobox:
...
- button "Đăng ký"
- dialog: Tài khoản đã tồn tại! Đã xảy ra lỗi vui lòng quay lại trang chủ hoặc thử lại
```
