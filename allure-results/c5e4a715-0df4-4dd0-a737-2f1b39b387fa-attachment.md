...
- Name: api/users/updateInfoUser.spec.ts >> Update User Info API >> USER_API_007 - should update hoTen successfully
- Location: tests/api/users/updateInfoUser.spec.ts:59:7
