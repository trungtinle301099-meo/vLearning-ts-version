...
- Name: api/users/updateInfoUser.spec.ts >> Update User Info API >> USER_API_006 - should update matKhau successfully
- Location: tests/api/users/updateInfoUser.spec.ts:35:7
